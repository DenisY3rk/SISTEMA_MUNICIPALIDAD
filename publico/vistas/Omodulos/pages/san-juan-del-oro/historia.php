<div class="container modulo-historia">
    <div class="row">
        ...
        <div class="col m-auto me-5 modulo-historia-img">
            <img class="historia-img" src="<?php echo $servidor."../publico/vistas/img/plantilla/muni-san-juan-del-oro.jpg";?>" alt="">
        </div>    
    </div>

    <div class="row">
        <div class="col ms-5 me-5 mb-2">
        <p>
    ...
    <div class="row">
        ...
        <p>
        San Juan Del Oro tiene una población de 9.828 habitantes según datos del INEI
        (Instituto Nacional de Estadística e Informática). La población tiene origen
        principalmente Aymara (Conima, Moho, Tilali y Huancané), y en segundo lugar
        quechua (San Antonio de Putina y Azangaro). Traen consigo el uso de los idiomas
        Aymara y Quechua, la concepción andina de familia extensa, las relaciones de
        reciprocidad en labores de siembra y cosecha y la religiosidad andina como la ofrenda a
        la Pachamama (madre tierra).
        De los 9.828 habitantes de San Juan Del Oro, 4.503 son mujeres y 5.325 son hombres.
        Por lo tanto, el 54,18 por ciento de la población son hombres y el 45,82 mujeres
        </p>
        </div>
    </div>
</div>
